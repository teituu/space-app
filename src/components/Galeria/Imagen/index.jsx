...
const Imagen = ({ foto, expandida = false, alSolicitarZoom, alAlternarFavorito }) => {
    ...
    const iconoFavorito = foto.favorita ? "public/img/iconos/favorito-activo.png" : "public/img/iconos/favorito.png"
            ...
            <figcaption>
                ...
                <Pie>
                    ...
                    {!expandida && <BotonIcono aria-hidden={expandida} onClick={() => alSolicitarZoom(foto)}>
                        <img src="public/img/iconos/expandir.png" alt="Icono de expandir" />
                    </BotonIcono>}
                </Pie>
            </figcaption>
        </Figure>)
